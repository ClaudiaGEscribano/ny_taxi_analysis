...
Seen the general linear relationship, we can remove some of the outliers.
...
* Some linear relationship is found between the tip amount and:
  + fare amount
  + trip distance
  + trip duration
* Most of the data records are from and to Manhattan
* Most of the trips are made during the day
* The distribution of the trips inside the same borough is different from those trips that are picked up in one borough and finised in a different one.
